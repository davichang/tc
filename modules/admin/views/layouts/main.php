        ...
        <div class="col-md-3 left_col">
            <div class="left_col scroll-view">
                <div class="navbar nav_title" style="border: 0;">
                    <a href="<?= Url::to(['/site'])?>" class="site_title"><i class="fa fa-paw"></i> <span>BeiYiTC</span></a>
                </div>
                        ...
                        \yiister\gentelella\widgets\Menu::widget(
                            ...
                            [
                                ...
                                "items" => [
                                    ...
                                    ["label" => "培训管理", "url" => Url::to(['/admin/training']), "icon" => "files-o"],
...
//                                        "items" => [
//
//                                            ["label" => "培训管理", "url" =>Url::to(['/admin/training/index'])],
//
...
//                                    ],
                                    ...
                                    [
                                        ...
                                        "items" => [
                                            ...
                                            ["label" => "部门管理", "url" => Url::to(['/admin/department'])],
                                            ["label" => "部门分类", "url" => Url::to(['/admin/department-cate/index']),],
                                            ["label" => "教师管理", "url" => Url::to(['/admin/user/index']),],
